...
use soroban_sdk::{
    ...
    contractclient, contracttype, panic_with_error,
...
pub fn finalize_grace_period(env: &Env, agreement_id: u128) {
    ...
    if crate::storage::is_agreement_grace_period_finalized(env, agreement_id) {
        return;
    }
    ...
    crate::storage::set_agreement_grace_period_finalized(env, agreement_id);
}
